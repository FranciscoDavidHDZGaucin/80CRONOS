...
/*
********	 INFORMACION ARCHIVO ***************** 
	Nombre  Archivo : productopromotor_detalle.php
 	Fecha  Creacion : 20/09/2016  
	Descripcion  : 
	 Copia del archivo   productopromotor_detalle.php  del  Proyecto  Pedidos 
	Modificado  Fecha  : 
*/
...
$historial=sprintf("SELECT * FROM historial_p WHERE folio=%s",
