...
$q_agentes=sprintf("select cve_age as n_agente, nom_age as agente from relacion_gerentes WHERE cve_gte=%s  order by agente",
...
<div  class="container"> 
   <div class="table-responsive">
    <table  class="table table-responsive table-bordered">
       ...
       <form action="Nuevo.php" method="post" target="_self">
        <tbody>
