...
mysqli_select_db($conecta1, $database_conecta1);
     $string_agentes=sprintf("SELECT * FROM relacion_gerentes WHERE cve_gte=%s order by nom_age",
                    ////       GetSQLValueString($_SESSION['usuario_relaciongte'], "int")); 
                          GetSQLValueString($_SESSION['tipousuario_proyeccion'], "int"));
...
<div  class="container">
   ...
   <br>
    ...
    <!---<form class="form-inline" name="form1" action="<?php echo $archivo; ?>" method="post">-->
        <form class="form-inline" name="form1" action="crear12.php" method="post">
    ...
    <div class ="row"> 
        <form  class="form-group" id="Formulario1" name="Formulario1" method="post" action="crear22_grilla.php"  >
