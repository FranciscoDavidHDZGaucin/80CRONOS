...
////**coti_index_agente_option.php 
/*
********	 INFORMACION ARCHIVO ***************** 
	Nombre  Archivo : coti_index_agente_option.php  
 	Fecha  Creacion : 24/07/2017
	Descripcion  : 
 *            Index   con los Diferentes  Modulos  de Cotizacion para el Agente
 * 
 *     Modificaciones : 
 *          24/07/2017   Se Define la  Variable  TypePg 
 *                      Entiendase  que  la  Varible  TypePg  en  Estado  =>  0  =>La  Pagina   Se ejecutara  con opciones Nuevo Estatus  
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                        <div class="tile">
                            ...
                            <h3 class="tile-title">Nueva Cotizaciones</h3>
                            <p>
                               Generar Nueva Cotizacion 
                            </p>
                            <a class="btn btn-primary btn-large btn-block" href="coti_addCotiza_agente.php?TyPg=0">Nueva Cotizacion</a>
                 ...
                 <!-----Publicidad---->
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                        <div class="tile">
                          ...
                          <a class="btn btn-primary btn-large btn-block" href="coti_estus_coti_agente.php?TypePg=1">Estatus Cotizacion</a>
                 ...
                 <!--
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                        <div class="tile">
                            ...
                            <a class="btn btn-primary btn-large btn-block" href="coti_estus_coti_agente.php?TypePg=2">Ver Historial Cotizaciones</a>
