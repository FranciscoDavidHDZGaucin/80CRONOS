...
////***coti_index_gerente_option.php 
/*
********	 INFORMACION ARCHIVO ***************** 
	Nombre  Archivo : coti_index_gerente_option.php 
 	Fecha  Creacion : 03/08/2017
	Descripcion  : 
 *            Index   con los Diferentes  Modulos  de Cotizacion para el Agerente 
 * 
 *     Modificaciones : 
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                        <div class="tile">
                            ...
                            <a class="btn btn-primary btn-large btn-block" href="coti_addCotiza_gerente.php?TyPg=0">Nueva Cotizacion</a>
                 ...
                 <!-----Publicidad---->
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                        <div class="tile">
                            ...
                            <a class="btn btn-primary btn-large btn-block" href="coti_estus_coti_gerente.php?TypePg=1">Estatus Cotizacion</a>
                 ...
                 <!-----Publicidad--
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                        <div class="tile">
                            ...
                            <a class="btn btn-primary btn-large btn-block" href="#">Ver Historial Cotizaciones</a>
