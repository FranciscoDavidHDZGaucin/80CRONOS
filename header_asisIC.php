...
/*
********	 INFORMACION ARCHIVO ***************** 
	Nombre  Archivo :header_asisIC.php 
 	Fecha  Creacion : 08/06/2017 
	Descripcion  : 
 *              Header  para   la Asistente de  Inteligencia  Comercial 
  */
 session_start ();
  ...
  <div class="navbar navbar-inverse navbar-default navbar-fixed-top style_nav_001" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a  href="index_asisIC.php">  <img class="logo_cronos" src="arte_cronos/fon/logo_auto_12_2016.png"></a>
        
        </div>
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
              <li ><a href="index_asisIC.php">Inicio</a></li>          
            <li class="dropdown">
              <a href="" class="dropdown-toggle" data-toggle="dropdown">Publicidad<b class="caret"></b></a>
              <ul class="dropdown-menu">
               <li><a href="">Solicitudes Publicidad</a></li>
