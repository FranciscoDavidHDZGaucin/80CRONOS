<?php
////***+coti_estcotizaDC.php 
/*
********	 INFORMACION ARCHIVO ***************** 
	Nombre  Archivo : coti_estcotizaDC.php 
 	Fecha  Creacion :25/07/2017
	Descripcion  : 
 *             Escrip Diseñado  para  Autorizar  Solicitudes  de Cotizacion Dirreccion Comercial
 * 
 *      Modificacion  
...
////**Inicio De Session 
	 session_start ();
   $MM_restrictGoTo = "index_direccion.php";
...
<script type="text/javascript">
       const  PagReturn=  <?php echo "'http://192.168.101.17/sistemas/cronos/coti_indexoptDC.php'"; ?>;
      /////***Areglo en Bruto 
        var   ArgBrutMain ;   
       //////****Arreglo Principal
...
////**********************************
      ...
      if(coment != null  && coment != "" )
      {
          //////****Mandamos  Modificar el  Estatus 
              ////****Agregamos al cliente       
                 $.ajax({
                        type:'POST',
                        url: 'coti_scrip_cotiza/coti_UpdEstDC.php',
                        data:{"FL":nfolioVar,"TYPEST":typeEst ,"COME":coment }, 
                        success: function (datos) {
                                if(datos.ERRORES==0)
                                {
                                   ////**Exito  en Update  
            ...
            $("#btnNote").css("color","red");
                ...
                ////****Agregamos al cliente 
                 $.ajax({
                                  type:'POST',
                                  url: 'coti_scrip_cotiza/coti_UpdEstDC.php',
                                  data:{"FL":nfolioVar,"TYPEST":typeEst}, 
                                  success: function (datos) {
                                          if(datos.ERRORES==0)
                                          {
                                             ////**Exito  en Update  
 ...
 <div  class="container">
      ...
      echo      '<div class="col-sm-12">';
        ///***Cadena para Hacer
        $string_get_info = "SELECT folio , cve_agente , fecha_sol, estatus_Ic ,estatus_Dc as DirecEst,opczona FROM pedidos.coti_encabeca_cotizacion  where  estatus_Ic = 1 and estatus_DC =0   ";
      ...
      echo      '<div class="col-sm-12">';
        ///***Cadena para Hacer
        $string_get_info = "SELECT folio , cve_agente , fecha_sol, estatus_Ic ,estatus_Dc as DirecEst,opczona FROM pedidos.coti_encabeca_cotizacion  where   estatus_Ic = 1 and  (estatus_DC=1 || estatus_DC=2)  ";
        $qery_info = mysqli_query($conecta1, $string_get_info);
        }
         ...
         <div class="brdD row">
             ...
             <div class="row infoS">
                ...
                <div class="col-sm-5"> 
                    <?php   
                     /***Validacion Opcion solo  para Modificacion 
                       No Aplica en  Esta Parte  el  Type =1  y TypPeg =2 
                      *                       */
                   //  if($TypPeg==1){ ?> 
               ...
               if($TypPeg==2){?>
                 <form  action ="coti_maincotizacionIC.php?<?php echo "TyPg=3";  ?> "  method="POST"> 
                        <div class="col-sm-1">
