...
/*
********	 INFORMACION ARCHIVO ***************** 
	Nombre  Archivo : Get_002_8020.php 
 	Fecha  Creacion :15/05/2017 
	Descripcion  : 
 *             Escrip encargado  de Obtener  los Porcentajes y   Ordenar los  Arreglos  Positivo  y Negativos y además de  Seleccionar los elementos 80/20 
  */
...
$AREGLO_WHIT_ALL =  ARRAY (
    "ElPos" => json_encode($Are_only80PO), 
    "ElNeg" =>json_encode($Are_only80Ne)
);
