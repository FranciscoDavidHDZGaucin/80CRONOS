...
$STRING_CADENA_Html_002 = "<tr><td>Favor de Contestar  Desviaciones  Pendientes con Clave:".$OBJT->cveDes." </td></tr>";
$STRING_CADENA_Html_003 = "<tbody><tr><td><h4>Fecha Inicio: ".$OBJT->feIni."</h4></td><td><h4>Fecha Fin:".$OBJT->feFin."</h4></td></tr>";
$STRING_CADENA_Html_004 = "<tr><td>Comentarios Planeadora :".$COMENT."</td></tr></table>"; 
...
correos("Desviaciones Incompletas","Desviaciones Incompletas","egonzalez@agroversa.mx","fhernandez@agroversa.com.mx", $strin_Fina_HTML);

$array_result =  array (
    "Est"=>$STRIGN_CADENA_FIN_PLANEADOR///"Agente:".$correo_agente."  Gerente".$mail_gerente  /// $strin_Fina_HTML
);
