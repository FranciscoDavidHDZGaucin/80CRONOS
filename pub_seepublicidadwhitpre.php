<?php
////**pub_seepublicidadwhitpre.php 
/*
********	 INFORMACION ARCHIVO ***************** 
	Nombre  Archivo : pub_seepublicidadwhitpre.php  
 	Fecha  Creacion : 08/08/2017 
	Descripcion  : 
 *       Escrip  para Modificar Solo  Visualizar la  Publicidad  
 *       Sin Opcion para Modificar   
 *      
 *       Modificaciones : 
 *    
  */
               ...
               <?php
                  ...
                  while($row = mysqli_fetch_array( $qeryProd ) ){
                    echo '<tr>'; 
                              ...
                              //**Cantidad  Solicitada 
                              echo  '<td><input disabled type="int" value="'.$row['cantidad_solici'].'" class="CanSol'.$row['pub_cvepro'].' form-control"></td>';
                              ///**Precio Solicitado 
                              echo  '<td><input disabled step="any"  type="int" value="'.$row['precio_unitario'].'" class="PreSol'.$row['pub_cvepro'].'  form-control"></td>';
                              ////**Pre Total 
