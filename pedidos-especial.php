...
///$_SESSION["ORD"] = $_POST['ORD'];
 ...
 $_SESSION["MTPG"] != "") && $_SESSION["pago"] == "2"  ){
    ...
    $MM_restrictGoTo = "pedidos-especial_sigue.php";
...
<form method="post" enctype="multipart/form-data">
    <div class="container">
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="form-group">
                        ...
                        <div class="col-lg-1 col-sm-12">
                            ...
                            <div class="col-lg-2" id="plazo">
                                <label>Plazo:</label>
                                <input type="number" min="0" required name="plazo" value="<?php echo $dias;?>" >
        ...
        <div class=" ESPDF form-group">
            ...
            <div class="col-lg-12 col-sm-12">
            <div class="form-group">
                                <label class="radio col-sm-12"><!-- data-toggle="radio" data-radiocheck-toggle="radio"-->
