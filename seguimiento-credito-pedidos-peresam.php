<?PHP
 ///Incluye todo el contenido de la cabecera y menu que se aplica para el caso de ser un vendedor
  require_once('header_asisdir.php');
 // require_once('conexion_sap/sap.php');
// mssql_select_db("INTEGRADORA");
 
 require('Connections/conecta1.php');
  require_once('conexion_sap/sap.php');
 mssql_select_db("AGROVERSA");
require('formato_datos.php');   //para evitar poner la funcion de conversion de tipos de datos
