...
<div class="container">
    ...
    <form name="form1" method="post" action="clientes-edocta_gerentes.php">
        <p>
            ...
            ?>
              ...
              <div class="table-responsive">
                   <table  class="table table-responsive table-hover">
                        ...
                        <tbody>
                             <td><?php echo "$".floor(($sumasaldo)); ?></td>
                    ...
                    <table  class="table table-responsive table-hover">
                       ...
                       <tbody>
                           ...
                           <tr>
                               ...
                               <td><?php echo '$'.floor($registro1['DocTotal']);?></td>
                               <td><?php echo '$'.floor($registro1['saldo']);?></td>
