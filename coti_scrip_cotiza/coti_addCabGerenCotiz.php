...
//////****coti_addCabGerenCotiz.php 
/*
********	 INFORMACION ARCHIVO ***************** 
	Nombre  Archivo : coti_addCabGerenCotiz.php 
 	Fecha  Creacion :  02/08/2017
	Descripcion  : Generamos  Encabezado Gerente 
 * 
 *    Modificaciones :
...
///*****Agregar Normalmente  Una Cotizacion  typeusu  cve_gerente
if($TypeDespliegue == 0){
    
    $strADDcAB = sprintf("INSERT  INTO coti_encabeca_cotizacion  SET folio =%s,typeusu =2 ,cve_gerente=%s, com_agent=%s,opczona=%s ", 
...
if($TypeDespliegue == 1){
    ...
    $strADDcAB = sprintf("update   coti_encabeca_cotizacion  SET estatus_Ic=0,estatus_Dc=0 ,typeusu =2 ,cve_gerente=%s, com_agent=%s,opczona=%s where folio =%s ", 
