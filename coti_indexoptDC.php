...
/*
********	 INFORMACION ARCHIVO ***************** 
	Nombre  Archivo : coti_indexoptDC.php 
 	Fecha  Creacion : 25/07/2017
	Descripcion  : 
 *            Index   con los Diferentes  Modulos  de Cotizacion para el Director  Comercial  
 * 
 *     Modificaciones : 
                 ...
                 <!-----Publicidad---->
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                        <div class="tile">
                            ...
                            <a class="btn btn-primary btn-large btn-block" href="coti_estcotizaDC.php?TypePg=1">Estatus Cotizacion</a>
                 ...
                 <!-----Publicidad---->
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                        <div class="tile">
                            ...
                            <a class="btn btn-primary btn-large btn-block" href="coti_estcotizaDC.php?TypePg=2">Ver Historial Cotizaciones</a>
